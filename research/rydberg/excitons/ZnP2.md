...
This new project explores whether **Rydberg excitons in zinc phosphide (ZnP<sub>2</sub>)** can provide a route towards this goal.

## A new material for Rydberg excitons

Rydberg excitons have previously been studied extensively in Cu<sub>2</sub>O, including here in [Durham](cu2o/). However, optical losses in Cu<sub>2</sub>O can make it challenging to use these states for photonics.

ZnP<sub>2</sub> offers a promising alternative. It can support Rydberg excitons while exhibiting **50 times lower optical losses** than Cu<sub>2</sub>O. This means that light can interact with the Rydberg excitons for longer before being absorbed or scattered.

Shown below is our first exciton spectrum from ZnP<sub>2</sub>, currently showing excitons up to *n* = 4. Crucially, the background absorption that limits optical applications in Cu<sub>2</sub>O is not present.

![](img/ZnP2spec.png)

## Rydberg exciton-polaritons

The next step is to place ZnP<sub>2</sub> inside a **microcavity**.
...
[Dr. Liam Gallagher](https://www.durham.ac.uk/staff/liam-a-gallagher/) (Principal Investigator) <br>
